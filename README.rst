...
or sourced from |npm|_ or others, and the compilation target is the
artifact (bundled file or a binary) that is produced through the
...
generated by calmjs are NOT meant for direct consumption of web clients
such as web browsers.  The produced artifact from this framework will be
usable through the AMD API.
